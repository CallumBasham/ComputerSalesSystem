...
public class Product  {
    ...
    public Product() {
        try {this.setProductImage(new Image(new FileInputStream("src/computerSystem/forms/content/Icon_Shop.png")));} catch(IOException ex) {System.out.println(ex.getMessage());}
    }
