...
import computerSystem.models.classes.productOptionalExtras.FirstClassDelivery;
import computerSystem.models.classes.productOptionalExtras.GiftWrapping;
import computerSystem.models.classes.productOptionalExtras.Warranty;
...
public class ProductView {
    ...
    @FXML private void handleButtonClick_purchase(Event ev) {
        ...
        Main.localOrder.localOrdersList.add(newOrder);
        newOrder.saveOrder();
        ...
        if(al.getResult() == ButtonType.YES) {
            ...
            if(userSeect == JFileChooser.APPROVE_OPTION){
                ...
                try{
                    ...
                    PrintWriter writer = new PrintWriter(fileWIthTXT, "UTF-8");
