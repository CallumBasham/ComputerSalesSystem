    ...
    private static boolean initializeDefaultRecords() {
        ...
        try(Statement query = DatabaseInteraction.getQuery()) {
            ...
            if(query.executeQuery("SELECT COUNT(*) RowCount FROM lkCountry").getInt("RowCount") < 236) {
                ...
                NodeList xmlNodes = DocumentBuilderFactory.newDefaultInstance().newDocumentBuilder().parse(DatabaseSchema.class.getResourceAsStream("dataSources/Countries.xml")).getDocumentElement().getChildNodes();
